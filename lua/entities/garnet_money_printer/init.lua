...
function ENT:Initialize()
	...
	self:SetColor(Color(255, 51, 255, 0))
...
function ENT:CreateMoneybag()
	...
	local Y = GAMEMODE.Config.garnetprintamount
	if amount == 0 then
		amount = 10
	end
...
function ENT:Use(activator)
	...
	DarkRP.notify(activator, 1, 4, "You have collected $"..self:GetNWInt("PrintA").." from a Garnet Printer.")
	self:SetNWInt("PrintA",0)
	end
end
