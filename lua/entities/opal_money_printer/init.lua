...
function ENT:Initialize()
	...
	self:SetColor(Color(102, 51, 0, 0))
...
function ENT:CreateMoneybag()
	...
	local Y = GAMEMODE.Config.opalprintamount
	if amount == 0 then
		amount = 10
	end
...
function ENT:Use(activator)
	...
	DarkRP.notify(activator, 1, 4, "You have collected $"..self:GetNWInt("PrintA").." from a Opal Printer.")
	self:SetNWInt("PrintA",0)
	end
end
