...
function ENT:Initialize()
	...
	self:SetColor(Color(255, 255, 204, 0))
...
function ENT:CreateMoneybag()
	...
	local Y = GAMEMODE.Config.quartzprintamount
	if amount == 0 then
		amount = 10
	end
...
function ENT:Use(activator)
	...
	DarkRP.notify(activator, 1, 4, "You have collected $"..self:GetNWInt("PrintA").." from a Quartz Printer.")
	self:SetNWInt("PrintA",0)
	end
end
